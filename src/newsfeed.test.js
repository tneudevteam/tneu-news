...
const {parsePage, getTotalPages} = require('./newsfeed');
...
describe('#getTotalPages', () => {
  it('should export getTotalPages function', () => {
    expect(getTotalPages).toBeInstanceOf(Function);
  });

  it('should return numnber of total pages', async () => {
    const totalPages = await getTotalPages();
    expect(totalPages).toEqual(508);
  });
});
  ...
  it('should return news array in valid format', async () => {
    ...
    expect(newsWithoutDates).toEqual([
      ...
      },
      {
        ...
        imageURL:
          'http://www.tneu.edu.ua/uploads/posts/2018-03/thumbs/1520441232_konferenciia1.jpg',
